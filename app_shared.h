...
inline constexpr int DEFAULT_CLIENT_ID = 102;
inline constexpr const char* DEFAULT_SYMBOL = "QBTS";
inline constexpr const char* HARDCODED_ACCOUNT = "U23164862";
inline constexpr int FIRST_DYNAMIC_REQ_ID = 1001;
inline constexpr int MARKET_DEPTH_NUM_ROWS = 20;
inline constexpr int WEBSOCKET_PORT = 8081; // Keep the short app's localhost IPC separate from the long app.
